...
namespace WebMagazines.DataAccess.Migrations
{
    ...
    [Migration("20260731132804_AddShoppingCartOrderHeaderAndDetails")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebMagazines.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("WebMagazines.Models.OrderDetails", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMagazines.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebMagazines.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WebMagazines.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WebMagazines.Models.OrderDetails", b =>
                {
                    b.HasOne("WebMagazines.Models.OrderHeader", "OrderHeader")
                        .WithMany("OrderDetails")
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebMagazines.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("WebMagazines.Models.OrderHeader", b =>
                {
                    b.HasOne("WebMagazines.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
